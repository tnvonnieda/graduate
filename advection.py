...
# b1 = advection(-1, 1, 20, 41, 1, 1.0, 2, 4, 'sdc', 'wrap', 'smooth', True)
# c1 = advection(-1, 1, 20, 81, 1, 1.0, 2, 4, 'sdc', 'wrap', 'smooth', True)
# d1 = advection(-1, 1, 20, 161, 1, 1.0, 2, 4, 'sdc', 'wrap', 'smooth', True)
# e1 = advection(-1, 1, 20, 321, 1, 1.0, 2, 4, 'sdc', 'wrap', 'smooth', True)
# f1 = advection(-1, 1, 20, 641, 1, 1.0, 2, 4, 'sdc', 'wrap', 'smooth', True)
# g1 = advection(-1, 1, 20, 1281, 1, 1.0, 2, 4, 'sdc', 'wrap', 'smooth', True)

# a2 = advection(-1, 1, 20, 21, 1, 1.0, 2, 4, 'sdc', 'wrap', 'smooth', False)
# b2 = advection(-1, 1, 20, 41, 1, 1.0, 2, 4, 'sdc', 'wrap', 'smooth', False)
# c2 = advection(-1, 1, 20, 81, 1, 1.0, 2, 4, 'sdc', 'wrap', 'smooth', False)
# d2 = advection(-1, 1, 20, 161, 1, 1.0, 2, 4, 'sdc', 'wrap', 'smooth', False)
# e2 = advection(-1, 1, 20, 321, 1, 1.0, 2, 4, 'sdc', 'wrap', 'smooth', False)
# f2 = advection(-1, 1, 20, 641, 1, 1.0, 2, 4, 'sdc', 'wrap', 'smooth', False)
# g2 = advection(-1, 1, 20, 1281, 1, 1.0, 2, 4, 'sdc', 'wrap', 'smooth', False)

# a3 = advection(-1, 1, 20, 21, 1, 1.0, 3, 5, 'sdc', 'wrap', 'smooth', True)
# b3 = advection(-1, 1, 20, 41, 1, 1.0, 3, 5, 'sdc', 'wrap', 'smooth', True)
# c3 = advection(-1, 1, 20, 81, 1, 1.0, 3, 5, 'sdc', 'wrap', 'smooth', True)
# d3 = advection(-1, 1, 20, 161, 1, 1.0, 3, 5, 'sdc', 'wrap', 'smooth', True)
# e3 = advection(-1, 1, 20, 321, 1, 1.0, 3, 5, 'sdc', 'wrap', 'smooth', True)
# # f3 = advection(-1, 1, 2, 641, 1, 1.0, 3, 5, 'sdc', 'wrap', 'smooth', True)
# # # g3 = advection(-1, 1, 20, 1281, 1, 1.0, 4, 6, 'sdc', 'wrap', 'smooth')
# # # h3 = advection(-1, 1, 20, 2561, 1, 1.0, 4, 6, 'sdc', 'wrap', 'smooth')

# a4 = advection(-1, 1, 20, 21, 1, 1.0, 3, 5, 'sdc', 'wrap', 'smooth', False)
# b4 = advection(-1, 1, 20, 41, 1, 1.0, 3, 5, 'sdc', 'wrap', 'smooth', False)
# c4 = advection(-1, 1, 20, 81, 1, 1.0, 3, 5, 'sdc', 'wrap', 'smooth', False)
# d4 = advection(-1, 1, 20, 161, 1, 1.0, 3, 5, 'sdc', 'wrap', 'smooth', False)
# e4 = advection(-1, 1, 20, 321, 1, 1.0, 3, 5, 'sdc', 'wrap', 'smooth', False)
# f4 = advection(-1, 1, 20, 641, 1, 1.0, 3, 5, 'sdc', 'wrap', 'smooth', False)
# # g4 = advection(-1, 1, 20, 71, 1, 1.0, 5, 7, 'sdc', 'wrap', 'smooth')
# # h4 = advection(-1, 1, 20, 81, 1, 1.0, 5, 7, 'sdc', 'wrap', 'smooth')

# a5 = advection(-1, 1, 20, 21, 1, 1.0, 4, 6, 'sdc', 'wrap', 'smooth', True)
# b5 = advection(-1, 1, 20, 41, 1, 1.0, 4, 6, 'sdc', 'wrap', 'smooth', True)
# c5 = advection(-1, 1, 20, 81, 1, 1.0, 4, 6, 'sdc', 'wrap', 'smooth', True)
# d5 = advection(-1, 1, 20, 161, 1, 1.0, 4, 6, 'sdc', 'wrap', 'smooth', True)

# a6 = advection(-1, 1, 20, 21, 1, 1.0, 4, 6, 'sdc', 'wrap', 'smooth', False)
# b6 = advection(-1, 1, 20, 41, 1, 1.0, 4, 6, 'sdc', 'wrap', 'smooth', False)
# c6 = advection(-1, 1, 20, 81, 1, 1.0, 4, 6, 'sdc', 'wrap', 'smooth', False)
# d6 = advection(-1, 1, 20, 161, 1, 1.0, 4, 6, 'sdc', 'wrap', 'smooth', False)
# e6 = advection(-1, 1, 20, 321, 1, 1.0, 4, 6, 'sdc', 'wrap', 'smooth', False)
# f6 = advection(-1, 1, 2, 641, 1, 1.0, 4, 6, 'sdc', 'wrap', 'smooth', False)

# a5 = advection(-1, 1, 20, 11, 1, 1.0, 6, 8, 'sdc', 'wrap', 'smooth')
# b5 = advection(-1, 1, 20, 21, 1, 1.0, 6, 8, 'sdc', 'wrap', 'smooth')
# c5 = advection(-1, 1, 20, 31, 1, 1.0, 6, 8, 'sdc', 'wrap', 'smooth')
# d5 = advection(-1, 1, 20, 41, 1, 1.0, 6, 8, 'sdc', 'wrap', 'smooth')
# e5 = advection(-1, 1, 20, 51, 1, 1.0, 6, 8, 'sdc', 'wrap', 'smooth')
# f5 = advection(-1, 1, 20, 61, 1, 1.0, 6, 8, 'sdc', 'wrap', 'smooth')
# g5 = advection(-1, 1, 20, 71, 1, 1.0, 6, 8, 'sdc', 'wrap', 'smooth')
# h5 = advection(-1, 1, 20, 81, 1, 1.0, 6, 8, 'sdc', 'wrap', 'smooth')

# a6 = advection(-1, 1, 20, 11, 1, 1.0, 7, 9, 'sdc', 'wrap', 'smooth')
# b6 = advection(-1, 1, 20, 21, 1, 1.0, 7, 9, 'sdc', 'wrap', 'smooth')
# c6 = advection(-1, 1, 20, 31, 1, 1.0, 7, 9, 'sdc', 'wrap', 'smooth')
# d6 = advection(-1, 1, 20, 41, 1, 1.0, 7, 9, 'sdc', 'wrap', 'smooth')
# e6 = advection(-1, 1, 20, 51, 1, 1.0, 7, 9, 'sdc', 'wrap', 'smooth')
# f6 = advection(-1, 1, 20, 61, 1, 1.0, 7, 9, 'sdc', 'wrap', 'smooth')
# f3 = advection(-1, 1, 20, 321, 1, 1.0, 4, 6, 'sdc', 'wrap', 'smooth')
# g3 = advection(-1, 1, 20, 1281, 1, 1.0, 4, 6, 'sdc', 'wrap', 'smooth')
# h3 = advection(-1, 1, 20, 2561, 1, 1.0, 4, 6, 'sdc', 'wrap', 'smooth')
# print(h.max_error)
# sys.exit()

# x_0, x_f, t_f, k, advection_velocity, CFL, r, p, time_int, boundary_type, problem_type
# plt.plot(sdc3.x, dc3.u, marker='.')
# plt.plot(sdc5.x, sdc5.u, marker='.')
# plt.plot(mod_sdc.x, mod_sdc.u, marker='.')

# plt.xlabel("Number of grid points")
# plt.ylabel(r'$L_{\infty}$ error')

# a = advection(-1, 1, 16, 11, 1, 1.0, 6, 8, 'sdc', 'wrap', 'smooth')
# a = advection(-1, 1, 16, 21, 1, 0.8, 2, 4, 'sdc', 'wrap', 'smooth')
# print('done')
# b = advection(-1, 1, 16, 41, 1, 0.8, 2, 4, 'sdc', 'wrap', 'smooth')
# print('done')
# c = advection(-1, 1, 16, 81, 1, 0.8, 2, 4, 'sdc', 'wrap', 'smooth')
# print('done')
# d = advection(-1, 1, 16, 161, 1, 0.8, 2, 4, 'sdc', 'wrap', 'smooth')
# print('done')
# e = advection(-1, 1, 16, 321, 1, 0.8, 2, 4, 'sdc', 'wrap', 'smooth')
# print('done')
# f = advection(-1, 1, 16, 641, 1, 0.8, 2, 4, 'sdc', 'wrap', 'smooth')
# g = advection(-1, 1, 16, 1281, 1, 1.0, 2, 4, 'sdc', 'wrap', 'smooth')
# # h1 = advection(-1, 1, 16, 2561, 1, 1.0, 2, 4, 'sdc', 'wrap', 'smooth')
# plt.xlabel(r'$x$')
# plt.ylabel(r'$u(x,t)$')
...
# # plt.title(r'$WENO13, p_{\beta}=r+1$')
# plt.title(r'$WENO13, p_{\beta}=2$')
...
# plt.title("RK4 vs SDC, advection at t=5s, CFL=0.5, 11th-Order WENO")
# plt.legend(["sdc, WENO 3", "sdc, WENO 5", "modified sdc", "rk4, WENO 5"])
# plt.show()
...
results_1 = np.array([a1, b1, c1, d1, e1, f1, g1])
...
results_2 = np.array([a2, b2, c2, d2, e2, f2, g2])
...
results_3 = np.array([a3, b3, c3, d3, e3])
...
results_4 = np.array([a4, b4, c4, d4, e4, f4])
...
# plt.xscale("log")
plt.plot(points_1[1:], convergence_1, linestyle="dashed", marker='o', markersize=8, color='black')
plt.plot(points_2[1:], convergence_2, linestyle="dashed", marker='^', markersize=8, color='black')
plt.text(points_1[-1] + 200, 4, r'$r=2$', fontsize='x-large', color='black')

plt.plot(points_3[1:], convergence_3, linestyle="dashed", marker='o', markersize=8, color='red')
plt.plot(points_4[1:], convergence_4, linestyle="dashed", marker='^', markersize=8, color='red')
plt.text(points_3[-1] + 100, 6, r'$r=3$', fontsize='x-large', color='red')

plt.plot(points_5[1:], convergence_5, linestyle="dashed", marker='o', markersize=8, color='navy')
plt.plot(points_6[1:], convergence_6, linestyle="dashed", marker='^', markersize=8, color='navy')
plt.text(points_5[-1] + 25, 8, r'$r=4$', fontsize='x-large', color='navy')

plt.ylabel(r'$r_{c,L_\infty}$', fontsize=24)
